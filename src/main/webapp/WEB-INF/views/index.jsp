...
<div class="row pb-5 mb-4" style="margin: 0">
    ...
    <c:forEach var="post" items="${posts}">
        ...
        <div class="modal fade" id="property${post.postId}" data-backdrop="static" tabindex="-1"
            ...
            <div class="modal-dialog " style="margin-left: 10%;margin-right: 10%">
                <div class="modal-content" style="width: 1200px;height: 550px;background-color: #03506f">
                    <div class="modal-header" >
                        <h5 class="modal-title" id="exampleModalLongTitle1" style="color: #FFFFFF">${post.property.name}</h5>
                    ...
                    <div class="modal-body" style="padding: 0">
                        <div class="card" style="margin: 0">
                            <div class="row">
                                <div class="col">
                                    <div class="card-img" style="padding: 10%;width: 550px;height: 350px">

                                        <div class="carousel slide" id="main-carousel" data-ride="carousel" style="height: 350px;width: 550px;padding-bottom: 10%; padding-right: 10%">
                                                        ...
                                                        <c:forEach var="image" items="${post.image}" varStatus="counter">
                                                            ...
                                                            <div class="carousel-item ${active}">
                                                                <img src="data:image/jpeg;base64,${image}"
                                                                     style="height:100%; width: 100%; crop: auto"
                                ...
                                <div class="col">
                                    <div class="card-body"
                                         style="font-family:Times New Roman, Times, serif;  padding: 20px; font-size: 16px; margin: 0; background-color: #222831">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <p style="padding-left: 40px; font-weight: bolder; font-size: 16px;color: white">Address</p>
                                            </div>
                                            <div class="col">
                                                <p class=" text-muted" style="margin: 0">${post.property.address}</p>
                                            </div>

                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <p style="padding-left: 40px; font-weight: bolder; font-size: 16px;color: white">Price</p>
                                            </div>
                                            <div class="col">
                                                <p class=" text-muted" >${post.property.cost}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <p style="padding-left: 40px; font-weight: bolder; font-size: 16px;color: white">Name</p>
                                            </div>
                                            <div class="col">
                                                <p class=" text-muted" >${post.owner.name}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <p style="padding-left: 40px; font-weight: bolder; font-size: 16px;color: white">Phone Number</p>
                                            </div>
                                            <div class="col">
                                                <p class=" text-muted" >${post.owner.phoneNumber}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <p style="padding-left: 40px; font-weight: bolder; font-size: 16px;color: white">Email</p>
                                            </div>
                                            <div class="col">
                                                <p class=" text-muted" >${post.owner.email}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="profile" data-backdrop="static" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="padding: 16px;background-color:  #000000">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle" style="color: white">Profile</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
