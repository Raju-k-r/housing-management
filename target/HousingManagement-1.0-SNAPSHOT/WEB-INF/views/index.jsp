...
<%--            </c:if>--%>
            ...
            <c:if test="${userType eq 'USER'}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<%=Mapping.MY_POSTS%>">MyPosts</a>
                </li>
            </c:if>
...
<div class="row pb-5 mb-4" style="margin: 0">
    ...
    <c:if test="${posts.size() == 0}">
        <div class="alert alert-secondary" role="alert"
             style=" border-color: white; border-width: thick;width: 80%;margin: 100px 100px;text-align: center;">
            <h4 class="alert-heading">There are no posts</h4>
    ...
    <c:forEach var="post" items="${posts}">
        ...
        <div class="modal fade" id="property${post.postId}" role="dialog" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">

            <div class="modal-dialog" style="margin-left: 18%; margin-right: auto" >
                <div class="modal-content" style="width: 1000px">
                    ...
                    <div class="modal-body" style="padding: 0">
                        <div class="card" style="margin: 0;background-color: #0a043c">
                            <div class="row">
                                <div class="col">
                                    <div class="card-img " style="height: 100%;width: 100%;">
                                        ...
                                        <div class="carousel slide" id="main-carousel" data-ride="carousel">
                                            <div class="carousel-inner">
                                                <c:forEach var="image" items="${post.image}">
                                                    <div class="carousel-item active" style="padding: 16px">
                                                        <img class="d-block img-fluid" style="height: 350px; width: 500px;padding-top: 10px; crop: auto"
                                                             src="data:image/jpeg;base64,${image}" alt="Property Image">
                                ...
                                <div class="col">
                                    <div class="card-body" style="font-family:Times New Roman, Times, serif;  padding: 20px; font-size: 16px; margin: 0; background-color: #222831; color: #FFFFFF">
                                        <div class="row">
                                            <p style="font-size: 24px;font-weight: bolder;color: white;padding-left: 10px">Property Details</p>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                            ...
                                            <div class="col text-muted">
                                                <p style="margin: 0">${post.owner.address}</p>
                                            </div>
                                        ...
                                        <hr>
                                        <div class="row">
                                            <p style="font-size: 24px;font-weight: bolder;color: white;padding-left: 10px">Owner Deatils</p>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                    ...
                    <c:if test="${post.user.userId == user.userId}">
                        <div class="modal-footer">
                            ...
                            <label for="actual-btn">Add Property Image</label>
                                <%--                            <input href="/addToWishList/${post.property.propertyId}" name="" class="btn-primary" style="margin-left: 15rem; border-radius: 2rem; padding-left: 1.5rem; padding-right: 1.5rem; padding-top: 0.5rem; padding-bottom: 0.5rem" type="file" accept="image/jpeg">Add Property Image</input>--%>
                        </div>
                    </c:if>
                    <c:if test="${post.user.userId != user.userId}">
                        <div class="modal-footer">
                            <a href="/addToWishList/${post.property.propertyId}" name="" class="btn-primary" style="margin-left: 15rem; border-radius: 2rem; padding-left: 1.5rem; padding-right: 1.5rem; padding-top: 0.5rem; padding-bottom: 0.5rem" type="submit">Add to Wishlist</a>
                        </div>
                    </c:if>
                </div>
            </div>
...
<%--                    <c:if test="${ (post.user.userId == user.userId) || (userType eq 'ADMIN')}">--%>
<%--                        <div class="modal-footer">--%>
<%--                            <div class="modal-footer">--%>
...
<%--                        </div>--%>
<%--                    </c:if>--%>
<%--                    <c:if test="${ (post.user.userId != user.userId) && (userType eq 'USER')}">--%>
<%--                        <h1>(post.user.userId != user.userId) = ${(post.user.userId != user.userId)}</h1>--%>
<%--                        <h1>!(userType eq 'ADMIN') = ${!(userType eq 'ADMIN')}</h1>--%>
<%--                        <div class="modal-footer">--%>
